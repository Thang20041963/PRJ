                        ...
                        <c:forEach items="${requestScope.ProductData}" var="p">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button type="button" class="btn btn-primary btn-sm dlt" title="Xóa ảnh" data-toggle="modal" data-target="#myModal3${p.getId()}"><i
                                            class="fas fa-minus-circle"></i></button>       
                                    <button type="button" class="btn btn-primary btn-sm" title="Thêm ảnh" data-toggle="modal" data-target="#myModal${p.getId()}"><i
                                            class="fas fa-plus-circle"></i></button>

                                </td>
                            </tr>
                            <!-- Modal3 -->
                        <div class="modal fade" id="myModal3${p.getId()}" role="dialog">
                            <div class="modal-dialog">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <label class="control-label">Xóa Ảnh sản phẩm</label>
                                        <form action="productmanager?action=deleteimage" method="POST">
                                            <div id="myfileupload">
                                                <input type="hidden" name="product_id" value="${p.getId()}" /> 
                                                <select  name="product_img" >
                                                     <c:forEach var="i" items="${p.getImg()}">
                            ...
                            <div class="modal-dialog">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form action="productmanager?action=addimage" method="POST">
                                            <div id="myfileupload">
                                                <input type="hidden" name="product_id" value="${p.getId()}" />
