                                                                    ...
                                                                    <c:set var="total" value="${0}"/>
                                                                        <div class="cart-dropdown">
                                                                            ...
                                                                            <div class="cart-list">
                                                                              ...
                                                                              pattern="#,##0" value = "${i.product.outPrice-(i.product.outPrice*i.product.discount)}" /> VND</h4>
                                                                                        ...
                                                                                        <form name="a" action="process" method="post">
                                                                                            ...
                                                                                            <input type="hidden" name="page" value="productdetails?productId="/>
                                                                            ...
                                                                            <div class="cart-summary">
                                                                                ...
                                                                                <h5>SUBTOTAL: <fmt:formatNumber type = "number"   maxFractionDigits = "3"
							...
							<div class="tab-content">
								...
								<div id="tab3" class="tab-pane fade in">
									<div class="row">
										...
										<div class="col-md-3">
											<div id="review-form">
                                                                                            <form class="review-form" action="review" method="get" name="">
