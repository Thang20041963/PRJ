                        ...
                        <div class="tile-body">
                            ...
                            <form class="row" action="productmanager?action=insertproduct" method="post" >
                                ...
                                <div class="form-group  col-md-3">
                                    ...
                                    <input class="form-control" name="in_price" type="text" value="">
                                </div>
                                <div class="form-group  col-md-3">
                                    <label class="control-label">Giá bán </label>
                                    <input class="form-control" name="out_price" type="text" value="">
                                </div>
                                <div class="form-group col-md-3">
                                    <label class="control-label">Kiểu loại</label>
                                    <input class="form-control" placeholder="Blue,Gray,..." name="type" type="text" value="">
                                </div>
                                <div class="form-group col-md-3">
                                    <label class="control-label">Hãng</label>
                                    <input class="form-control" name="brand" type="text" placeholder="S,L,XL,..." value="">
                                </div>
                                
                                <div class="form-group  col-md-3">
                                    <label class="control-label">Số lượng phím</label>
                                    <input class="form-control" name="nokc" type="text" value="">
                                </div>
                                <div class="form-group  col-md-3">
                                ...
                                <div class="form-group  col-md-3">
                                    ...
                                    <input class="form-control" name="material" type="text" value="">
                                </div>
                                <div class="form-group  col-md-3">
                                    <label class="control-label">Tương thích</label>
                                    <input class="form-control" name="suitability" type="text" value="">
                                </div>
                                <div class="form-group  col-md-3">
                                    <label class="control-label">Độ dày phím</label>
                                    <input class="form-control" name="density" type="text" value="">
                                </div>
                                <div class="form-group  col-md-3">
