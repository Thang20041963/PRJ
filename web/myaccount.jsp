...
display: block;
                                    ...
                                    <c:set value="${acc.getAccountOrder()}" var="ord"/>   
                                                        ...
                                                        <tbody>
                                                            <c:forEach var="order" items="${ord}" >                                                            
                                                                <tr>
                                                                    ...
                                                                    <td>${order.getReceiveLocation()}</td>
                                                                    <td>${order.getOrderDate()}</td>    
                                                                    <td>${order.getTotalPrice()}</td>
                                                                    <td><button type="button" onclick="detail(${order.getId()})">Detail</button></td>
                                                                </tr>
                                                            </c:forEach>
                                                        </tbody>
                                                    </table>
                                    ...
                                    <script >
                                        function detail(id){
                                            window.location.href = "customerorderdetail?id=" + id;
                                        }
                                    </script> 
                                ...
                                <div class="col-md-5">
                                    ...
                                    <form name="f" action="account" method="post">
                                        <div class="form-group">
                                            Username:
                                            <input class="input" type="text" name="username"  value="${acc.username}">
                                            Full Name:
                                            <input class="input" type="text" name="fullname"  value="${acc.fullname}">
                                            Phone Number:	
                                            <input class="input" type="tel" name="phone"  value="${acc.phonenumber}">
                                            Email:
                                            <input class="input" type="text" name="email"  value="${acc.email}">
                                            ...
                                            DOB:	
                                            <input class="input" type="date" name="dob"  value="${acc.birthday}">
                                            ...
                                            <input style="color: red" type="submit" class="input" name="update" value="save"/> 
                                    </form>                                      
                                </div>
                                 <div class="col-md-3">
                                    ...
                                    <form name="f" action="account" method="post">
                                        <div class="form-group">
                                            Old Password:<input class="input" type="password" name="oldpass" >
                                            New Password:<input class="input" type="password" name="newpass" >
                                            Re-enter Password:<input class="input" type="password" name="checkpass" >
                                            
                                        </div>
                                        <input style="color: red" type="submit" class="input" name="update" value="change"/>
