						...
						<div class="order-summary">
							...
							<div class="order-products">
								...
								<div class="order-col">
									...
									<div>${i.product.outPrice-(i.product.outPrice*i.product.discount)}K VND</div>
								</div>
                                                                <c:set var="total" value="${total + (i.product.outPrice-(i.product.outPrice*i.product.discount))*i.quantity}" />
                                                            </c:forEach>
							...
							<div class="order-col">
								<div><strong>TOTAL</strong></div>
								<div><strong class="order-total">${total}K VND</strong></div>
							</div>
						</div>
						
                                                        <form name="f" action="checkout" method="get" >
